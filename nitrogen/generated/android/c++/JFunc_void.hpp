...
namespace margelo::nitro::nativeui {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nativeui/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nativeui/Func_void_cxx;";

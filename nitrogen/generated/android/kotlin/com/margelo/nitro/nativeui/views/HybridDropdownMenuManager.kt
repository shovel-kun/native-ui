...
/**
 * Represents the React Native `ViewManager` for the "DropdownMenu" Nitro HybridView.
 */
class HybridDropdownMenuManager: SimpleViewManager<View>() {
  private val views = hashMapOf<View, HybridDropdownMenu>()
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridDropdownMenu(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridDropdownMenuStateUpdater.updateViewProps(hybridView, stateWrapperImpl)

...
/**
 * Represents the React Native `ViewManager` for the "Text" Nitro HybridView.
 */
class HybridTextManager: SimpleViewManager<View>() {
  private val views = hashMapOf<View, HybridText>()
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridText(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridTextStateUpdater.updateViewProps(hybridView, stateWrapperImpl)
